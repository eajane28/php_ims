...
{
    mysqli_query($link, "insert into purchase values(NULL,'$_POST[companyname]','$_POST[productname]','$_POST[unit]','$_POST[packingsize]','$_POST[qty]','$_POST[price]','$_POST[type]','$_POST[dt]', '$_SESSION[admin]')");
    $count=0;

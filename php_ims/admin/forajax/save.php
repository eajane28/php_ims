...
if(isset($_SESSION['cart']))
{
    ...
    $check_available=0;
    $check_available=check_duplicate($companyname,$productname, $unit, $packingsize);
    $available_qty=0;
    $check_the_qty=0;

    if($check_available==0)
    {
        $available_qty=check_qty($companyname,$productname, $unit, $packingsize, $link);
        if($available_qty>=$qty)
        {
            $b=array("companyname"=>$companyname,"productname"=>$productname,"unit"=>$unit,"packingsize"=>$packingsize,"price"=>$price,"qty"=>$qty);
    ...
    else
    {
        $av_qty=0;
        $exist_qty=0;
        $exist_qty=check_the_qty($companyname,$productname, $unit, $packingsize);
    ...
    if($available_qty>=$qty)
    {
        $_SESSION['cart']=array(array("companyname"=>$companyname,"productname"=>$productname,"unit"=>$unit,"packingsize"=>$packingsize,"price"=>$price,"qty"=>$qty));
    } 
    else{
